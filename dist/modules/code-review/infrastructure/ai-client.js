...
import { structuredReviewSchema } from "./schemas.js";
...
export class AiCodeReviewer {
    ...
    constructor() {
        ...
        const baseURL = env.OPEN_ROUTER_API_KEY ? "https://openrouter.ai/api/v1" : undefined;
    ...
    async analyzeDiff(diff) {
        try {
            const completion = await this.client.beta.chat.completions.parse({
                ...
                response_format: zodResponseFormat(structuredReviewSchema, "review_result"),
            });
