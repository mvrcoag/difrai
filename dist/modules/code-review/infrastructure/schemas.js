import { z } from "zod";
export const FINDING_SEVERITY_VALUES = ['critical', 'warning', 'info'];
...
export const reviewFindingSchema = z.object({
    ...
    suggestion: z
        .string()
        .nullable()
        .describe('Suggested fix or improvement in natural language, or null if none'),
    codeSuggestion: z
        .string()
        .nullable()
        .describe('A concise code snippet or diff illustrating the fix. Use Markdown backticks for code blocks. Null if not applicable.'),
});
export const structuredReviewSchema = z.object({
    summary: z
        .string()
        .describe('A 2-3 sentence overall summary of the commit quality and main concerns'),
    overallSeverity: z
